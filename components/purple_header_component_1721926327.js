...
Vue.component("purple_header_component_1721926327", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Ethereum Analyzer-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Ethereum Analyzer.html" :class="[textStylePrimary, hoverTextStylePrimary]">Ethereum Analyzer</a></li>
                        ...
                        <li><a id="Login-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Login.html" :class="[textStylePrimary, hoverTextStylePrimary]">Login</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            ...
                            <li><a id="mobile-Ethereum Analyzer-link" class="flex font-medium text-sm py-1.5" href="Ethereum Analyzer.html" :class="[textStylePrimary,hoverTextStylePrimary]">Ethereum Analyzer</a></li>
                            ...
                            <li><a id="mobile-Login-link" class="flex font-medium text-sm py-1.5" href="Login.html" :class="[textStylePrimary,hoverTextStylePrimary]">Login</a></li>
                        </ul>
                    </nav>
