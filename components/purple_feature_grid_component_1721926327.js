...
Vue.component("purple_feature_grid_component_1721926327", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the game with our cutting-edge transaction monitoring system. Get instant alerts and insights on new Ethereum transactions as they happen.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our powerful analytics engine to gain deep insights into transaction patterns, identify trends, and make data-driven decisions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor the app to your specific needs. Set up custom alerts for transactions meeting certain criteria, ensuring you never miss critical events.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our app seamlessly integrates with your existing Ethereum infrastructure, providing a unified view of your transactions and analytics.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Secure and Reliable</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Built with robust security measures, our app ensures the protection of your data while providing reliable and uninterrupted transaction monitoring.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Enjoy a clean and intuitive interface that makes navigating and analyzing Ethereum transactions a breeze, even for non-technical users.</p></div>
        </div>
    </div>`,
        data() {
            return {
